...
#funzione crea colonne derivate
def colonne_derivate(df):
    
    #Crea le colonne derivate:  km_per_year, price_per_hp: rapporto prezzo per cavallo
...
#funzione grafico a linee medio se comfort conveniene esiste

def plot_line_avg_price_by_comfort(df):
